...
export const messages = {
  ...
  legal: {
    title: "利用規約・免責事項・連絡先",
    backToApp: "← デザイン画像→HTML初稿 変換ツールに戻る",
    termsHeading: "利用規約",
    terms: [
      "本サービスはデモンストレーション目的のみで提供されます。商用利用・再配布は禁止します。",
      "サービスの内容は予告なく変更・停止する場合があります。",
      "アップロードされたデザイン画像・生成物は毎日 JST 03:00 に自動削除されます。",
      "本サービスの利用に際し、本規約に同意したものとみなします。",
    ],
    disclaimerHeading: "免責事項",
    disclaimer: [
      "生成されるHTML初稿は文字がプレースホルダの下書きであり、実際の文章・装飾に差し替えてご利用ください。",
      "デザイン画像の解析結果（帯の分割・種別判定）の正確性を保証するものではありません。",
  ...
  errors: {
    ...
    invalid_kind: "指定された種別は存在しません。",
    analysis_timeout: "解析処理が30秒以内に完了しなかったため、処理を中断しました。時間をおいて再度お試しください。",
    analysis_unreachable: "解析サービスに接続できなかったため、処理を中断しました。時間をおいて再度お試しください。",
    analysis_decode_failed: "解析サービスが画像を読み込めませんでした。時間をおいて再度お試しください。",
